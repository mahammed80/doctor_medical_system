...
export const STEPS = [
  ...
  { step: '04', title: 'احجز موعدك وتواصل', desc: 'اختر الموعد المناسب لجلستك مع الطبيب عبر محادثة آمنة' },
] as const
...
export const FAQS = [
  { q: 'كيف يمكنني حجز استشارة في مركز بترجي؟', a: 'العملية بسيطة للغاية وتستغرق أقل من 5 دقائق: اختر الطبيب المناسب لحالتك، املأ بياناتك الطبية وأرفق الأشعة إن وجدت، قم بسداد رسوم الاستشارة بأمان، ثم اختر الموعد المناسب لك من جدول الطبيب المباشر للتواصل عبر محادثة آمنة مع الطبيب.' },
...
export const TESTIMONIALS = [
  ...
  { text: 'بعد إصابتي في الركبة، تواصلت مع د. خالد بترجي وأعدّ لي برنامج تأهيل حركي منزلي رائع وتابع معي خطوة بخطوة حتى عدت لممارسة الرياضة بشكل طبيعي.', name: 'فهد السبيعي', title: 'مريض — جراحة العظام والرياضة' },
] as const
